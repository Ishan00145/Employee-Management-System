...
const AllFeedbacks = () => {
  ...
  return (
    <div className="all-feedbacks-container" ref={ComponentsRef}>
      <style>
        {`
          @media print {
            .print-button {
      ...
      <h1 className="all-feedbacks-title">All Feedbacks </h1><button className="print-button" onClick={handlePrint}>print</button>
